...
data={
    ...
    'peso':[100, 200, 300, 400, 500, 600, 700, 800],
...
# Correccion estaba tomando columna tipo_de_fruta que es string 
# lo que hacemos es tomar solo los float y int 

# Excluir la columna 'tipo_de_fruta' del cálculo de la matriz de correlación
columnas_numericas = df_frutas.select_dtypes(include=[float, int]).columns
print(f"Columnas numericas-------------------\n{columnas_numericas}")
correlacion= df_frutas[columnas_numericas].corr()
print(correlacion)
